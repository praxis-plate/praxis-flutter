...
abstract class CourseImportResultDto implements _i1.SerializableModel {
  CourseImportResultDto._({
  ...
  }) = _CourseImportResultDtoImpl;

  factory CourseImportResultDto.fromJson(
  ...
  /// Returns a shallow copy of this [CourseImportResultDto]
  /// with some or all fields replaced by the given arguments.
  @_i1.useResult
  CourseImportResultDto copyWith({
    _i2.CourseDto? course,
    List<_i3.ModuleDto>? modules,
    List<_i4.LessonDto>? lessons,
    List<_i5.TaskDto>? tasks,
  ...
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'CourseImportResultDto',
...
class _CourseImportResultDtoImpl extends CourseImportResultDto {
  _CourseImportResultDtoImpl({
    required _i2.CourseDto course,
    required List<_i3.ModuleDto> modules,
    required List<_i4.LessonDto> lessons,
